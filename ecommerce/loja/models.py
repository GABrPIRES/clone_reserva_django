...
class ItemEstoque(models.Model):
    ...
    def __str__(self) -> str:
        return f"{self.produto.nome}, Tamanho: {self.tamanho}, Cor: {self.cor.cor}"
...
class Endereco(models.Model):
    ...
    def __str__(self) -> str:
        return (
            f"{self.cliente} - {self.rua} - {self.cidade} - {self.estado} - {self.cep}"
        )
...
class ItensPedido(models.Model):
    ...
    def __str__(self):
        return f"Id pedido: {self.pedido.id} - Produto: {self.item_estoque.produto.nome}, {self.item_estoque.tamanho}, {self.item_estoque.cor.cor}, {self.quantidade}"
